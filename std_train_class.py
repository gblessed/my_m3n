...
wandb.init(project='gnn', name='class_p')
...
if __name__ == "__main__":
    ...
    if args.ds == "CBR+MB":
        ...
        model = std_models_sigmoid.Baseline_cbr_mb
    elif args.ds == "MB":
        ds_path = "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/extracted_moblus_devices_cv"
        model = std_models_sigmoid.Baseline_mb
    else:
    ...
    if not args.cfv:
        ...
        trained_model, evaluation = train_and_evaluate(
            ...
            (r"/home/ec2-user/gnnet-ch23-dataset-cbr-mb/cbr_train_packets_class", r"/home/ec2-user/gnnet-ch23-dataset-cbr-mb/cbr_test_packet_class"),
            model(),
