...
usage
python3 /home/ec2-user/ITU-ML5G-PS-007-GNN-m0b1us/std_train.py -ds CBR+MB --ckpt-path moblus_mb 
"""
...
wandb.init(project='gnn', name='jitter_big')
...
def custom_loss(y_true, y_pred):
    print("y_pred ",len(y_pred), len(y_true))
...
if __name__ == "__main__":
    ...
    # Check the scenario
    if args.ds == "CBR+MB":
        ds_path = r"G:\My Drive\Fall23\Capstone Research\new_efforts\batch_4"
        model = std_models_pkts.Baseline_cbr_mb
    elif args.ds == "MB":
        ds_path = "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/extracted_moblus_devices_cv"
        model = std_models_pkts.Baseline_mb
    else:
    ...
    if not args.cfv:
        ...
        trained_model, evaluation = train_and_evaluate(
            ...
            (r"/home/ec2-user/gnnet-ch23-dataset-cbr-mb/cbr_train_jitter_indx_2", r"/home/ec2-user/gnnet-ch23-dataset-cbr-mb/cbr_test_jitter_indx_2"),
            model(),
