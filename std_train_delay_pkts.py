...
usage
python3 /home/ec2-user/ITU-ML5G-PS-007-GNN-m0b1us/std_train_delay_pkts.py -ds CBR+MB --ckpt-path moblus_multi 
...
wandb.init(project='gnn', name='delay_jitter')
...
if __name__ == "__main__":
    ...
    if args.ds == "CBR+MB":
        ...
        model = std_models_delay_pkts.Baseline_cbr_mb
    elif args.ds == "MB":
        ds_path = "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/mb_extracted_cv"
        model = std_models_delay_pkts.Baseline_mb
    else:
