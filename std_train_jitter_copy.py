...
usage
python3 /home/ec2-user/ITU-ML5G-PS-007-GNN-m0b1us/std_train_jitter.py -ds CBR+MB --ckpt-path moblus_mb 
...
# wandb.init(project='gnn', name='jitter_only')
...
def train_and_evaluate(
    ...
    x_train = []
    for x, delay, jitter, pkts_dropped in ds_train:
        x_train.append((x,jitter))

    ds_train = x_train

    x_val = []
    for x, delay, jitter, pkts_dropped in ds_val:
        x_val.append((x,jitter))
...
if __name__ == "__main__":
    ...
    if args.ds == "CBR+MB":
        ...
        model = std_models_jitter.Baseline_mb
    else:
