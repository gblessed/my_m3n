...
wandb.init(project='gnn', name='jitter_class')
...
def train_and_evaluate(
    ...
    # Load checkpoint
    ckpt_path = "/home/ec2-user/ckpt/moblus_mb"
    restore_ckpt = False
...
if __name__ == "__main__":
    ...
    # Check the scenario
    if args.ds == "CBR+MB":
        ds_path = "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/batch_4"
    ...
    if not args.cfv:
        ...
        trained_model, evaluation = train_and_evaluate(
            ...
            # ("/home/ec2-user/gnnet-ch23-dataset-cbr-mb/extracted_moblus_devices_cv/3/training", "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/cbr_test_only_comb" ),
            model(),
