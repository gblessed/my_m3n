...
'''
python3 /home/ec2-user/ITU-ML5G-PS-007-GNN-m0b1us/std_predict.py -ds CBR+MB --ckpt-path /home/ec2-user/ckpt/mb_transformer2/19-16.6587 \
--tr-path /home/ec2-user/gnnet-ch23-dataset-cbr-mb/extract_plot_cv/0/training \
--te-path /home/ec2-user/gnnet-ch23-dataset-cbr-mb/extract_plot_test
'''
...
def predict(
    ...
    if verbose:
        print()
    for ii, (sample_features, _,_,_) in enumerate(iter(ds)):
        if verbose:
            print(f"\r Progress: {ii} / {len(ds)}", end="")
        # print("KEYS=",sample_features.keys() )
...
if __name__ == "__main__":
    ...
    # Check the scenario
    if args.ds == "CBR+MB":
        model = std_models_predict.Baseline_cbr_mb()
    elif args.ds == "MB":
        model = std_models_predict.Baseline_mb()
    else:
