...
class Baseline_cbr_MoE(tf.keras.Model):
    ...
    def __init__(self, override_mean_std_scores=None, name=None):
        ...
        self.expert1 = Baseline_mb_attn(name = "expert1")
        self.expert2 = Baseline_mb_attn(name = "expert2")
        self.expert_gate = std_models_jitter_binary.Baseline_mb_attn(name = "expertgate")
    ...
    def call(self, inputs):
        ...
        delays = delay1[:, 0] * tf.cast(mask1, tf.float32) * route + delay2[:, 0] * tf.cast(mask2, tf.float32) * route
